...
export async function processWithGemini(phone, contactName, message, conversationHistory=[]) {
  ...
  if (!apiKey) return { reply:`I'm currently unavailable. Please call us at ${CONTACT_PHONE}. Hare Krishna 🙏`, action:null };
